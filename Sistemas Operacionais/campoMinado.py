...
def imprime_mensagem_abertura():
    print("Olá, bem vindo ao Campo Minado de Algoritmos do Professor Marco Antonio!")
    print("O jogo foi desenvolvido por Lucas Emerick e Isabella Almeida!!!!")
    print()
...
while not RUNNING:  # laço principal do jogo
